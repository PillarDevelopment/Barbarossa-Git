...
contract TokenERC20 is Ownable
{
        ...
        returns (bool success)
    {
        ...
        balanceOf[msg.sender] -= _value*DEC;            // Subtract from the sender
        totalSupply -= _value*DEC;                      // Updates totalSupply
        avaliableSupply -= _value*DEC;
        Burn(msg.sender, _value*DEC);  // будет отображаться правильно, без +18 нулей
        return true;
    }
